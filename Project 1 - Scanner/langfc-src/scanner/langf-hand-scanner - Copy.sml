     ...
     let
		...
		fun stringStringBuilder strList strm0 =
			case charRdr strm0 of
				...
				| SOME (#"\a", strm1) => (badChar #"\a" ; stringStringBuilder strList strm1)
				| SOME (#"\b", strm1) => (badChar #"\b" ; stringStringBuilder strList strm1)
				| SOME (#"\f", strm1) => (badChar #"\f" ; stringStringBuilder strList strm1)
				| SOME (#"\n", strm1) => (badChar #"\n" ; stringStringBuilder strList strm1)
				| SOME (#"\r", strm1) => (badChar #"\r" ; stringStringBuilder strList strm1)
				| SOME (#"\t", strm1) => (badChar #"\t" ; stringStringBuilder strList strm1)
				| SOME (#"\v", strm1) => (badChar #"\v" ; stringStringBuilder strList strm1)
				(* Escape characters *)
				| SOME (#"\\", strm1) => 
																				...
																				(case charRdr strm3 of
																					SOME (c3, strm4) => if Char.isDigit c3
																										 then
																											...
																											in
																												if number > "255"
																													then (badChar c3; stringStringBuilder strList strm4)
																												else
																													case Char.scan charRdr strm0 of
																														NONE => (strList , strm4)
																														| SOME(c, strm) => stringStringBuilder (c::strList) strm4
																											end
																										else (badChar c3; stringStringBuilder strList strm2))
																			else (badChar c2; stringStringBuilder strList strm2))
											   else (badChar c1; stringStringBuilder strList strm2))
				| SOME (c, strm1) => stringStringBuilder (c::strList) strm1
				| NONE => (badChar #"0"; (strList,strm0))
